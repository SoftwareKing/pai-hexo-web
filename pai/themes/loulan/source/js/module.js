...
function() {
    var e = function() {
        var e, i, t, o, n, a, s, r, c, l, h, p, d, u, g, v = function() {
            if ($(".m-header").length) if (o = window.devicePixelRatio && cssua.ua.mobile ? window.devicePixelRatio: 1, e = $(window), i = $(".m-header"), i.append('<canvas id="wave-canvas"></canvas>'), n = document.getElementById("wave-canvas"), t = new createjs.Stage(n), a = new createjs.Shape, createjs.Ticker.setFPS(30), createjs.Ticker.addEventListener("tick", t), r = n.height - n.height / 2.7, c = n.height / 6.5, l = 60, h = .41, p = 2.5, d = 340, u = 2 * Math.PI / d, g = 10, Modernizr.canvas) {
                w();
        ...
        m = function() {
            ...
            n.width / o < 680 && (this.amp = 2 + 6 * Math.random(), this.freq = .018, this.phase = 1 + 2 * Math.random(), this.offset = 1 + 2 * Math.random()),
